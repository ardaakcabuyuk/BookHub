                    ...
                    echo "<div class=\"card-body\" onclick=\"location.href='review.php?post_id=".$row['post_id']."';\" style=\"cursor: pointer;\">";
                        ...
                        echo "<div class=\"card-footer\">";
                            ...
                            if(!$own_book)
                              ...
                              echo "<button type=\"submit\" name=\"reply_button\" value=\"reviews.php?book_id=".$row['book_id']."-". $row['post_id']. "\" class=\"btn btn-warning pull-right\" style=\"margin-left: 10px; margin-bottom:10px;\"><i class=\"fa fa-comment-o\"></i> Reply</button>";
                            echo "</form>";
