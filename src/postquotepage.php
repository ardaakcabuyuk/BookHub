                  ...
                  <div class="u-expanded-width u-form u-form-1">
                    <form action="post.php" method="POST" style="padding: 10px" source="custom" name="form-5">
                      ...
                      <div class="u-form-group u-form-submit">
                        <?php
                          echo "<button type=\"submit\" name=\"post_quote_button\" value=\"quotes.php"."-".$book_id."\" class=\"u-btn u-btn-round u-btn-submit u-button-style u-palette-3-base u-radius-13 u-btn-1\">Post Quote</button>";
                        ?>
                      </div>
                    </form>
                  </div>
